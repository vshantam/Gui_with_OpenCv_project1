...
class ImagePro(object):
    ...
    def App(self):
        ...
        # image
        path = tkFileDialog.askopenfilename(initialdir="/", title="Select file", filetypes=(
            ("jpeg files", "*.jpeg"), ("jpg files", "*.jpg"), ("png files", "*.png"), ("all files", "*.*")))
        ...
        if len(path) > 0:
            ...
            face_cascade = cv2.CascadeClassifier(
                'Haar_Cascade_Dataset/haarcascade_onfrtalface_default.xml')
            eye_cascade = cv2.CascadeClassifier('Haar_Cascade_Dataset/haarcascade_eye.xml')
